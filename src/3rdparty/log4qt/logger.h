...
#define LOG4QT_DECLARE_STATIC_LOGGER(FUNCTION, CLASS)                                        \
    static Log4Qt::Logger* FUNCTION()                                                        \
    {                                                                                        \
        static QBasicAtomicPointer<Log4Qt::Logger> p_logger = Q_BASIC_ATOMIC_INITIALIZER(0); \
        if (!p_logger) {                                                                     \
...
/*!
	 ...
	 */
class LOG4QT_API Logger : public QObject {
    Q_OBJECT
