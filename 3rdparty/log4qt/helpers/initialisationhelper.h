...
#define LOG4QT_GLOBAL_STATIC(TYPE, FUNCTION)                                                      \
    static QBasicAtomicPointer<TYPE> sp_global_static_##FUNCTION = Q_BASIC_ATOMIC_INITIALIZER(0); \
    TYPE* FUNCTION()                                                                              \
    {                                                                                             \
        if (!sp_global_static_##FUNCTION) {                                                       \
            TYPE* p_temp = new TYPE;                                                              \
...
#elif QT_VERSION < QT_VERSION_CHECK(5, 0, 0)
#define LOG4QT_IMPLEMENT_INSTANCE(TYPE)                                                   \
    static QBasicAtomicPointer<TYPE> sp_singleton_##TYPE = Q_BASIC_ATOMIC_INITIALIZER(0); \
    TYPE* TYPE::instance()                                                                \
    {                                                                                     \
        if (!sp_singleton_##TYPE) {                                                       \
            TYPE* p_temp = new TYPE;                                                      \
